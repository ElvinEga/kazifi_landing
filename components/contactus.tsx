        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex justify-center items-center gap-y-8 lg:gap-y-0 flex-wrap md:flex-wrap lg:flex-nowrap lg:flex-row lg:justify-between lg:gap-x-8 max-w-sm sm:max-w-2xl lg:max-w-full mx-auto">
            <div className="w-full lg:w-2/5">
              <span className="text-sm text-gray-500 font-medium mb-4 block lg:text-left text-center">
                Testimonial
              </span>
              <h2 className="text-4xl font-bold text-gray-900 leading-[3.25rem] mb-8 lg:text-left text-center">
              ...
              <div className="flex items-center gap-4 lg:justify-start justify-center">
                <button
                  ...
                  className="slider-button group flex justify-center items-center border border-solid border-indigo-600 w-12 h-12 transition-all duration-500 rounded-lg hover:bg-indigo-600"
                  data-carousel-prev=""
                >
                  <svg
            ...
            <div className="w-full lg:w-3/5">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8">
                ...
                <div className="group bg-white border border-solid border-gray-300 rounded-2xl max-sm:max-w-sm max-sm:mx-auto p-6 transition-all duration-500 hover:border-indigo-600 max-sm:hidden">
                  <div className="flex items-center gap-5 mb-5 sm:mb-9">
                    <img
