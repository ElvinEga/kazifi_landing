      ...
      <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        ...
        <div className="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
          ...
          <h2 className="text-2xl font-bold md:text-4xl md:leading-tight dark:text-white">
            PERSONALIZED APPLICATIONS WITH INSIGHTFUL ANALYTICS
          </h2>
        </div>
        {/* End Title */}
              ...
              >
                  ...
                  <span className="flex">
                    ...
                    <span className="grow ms-6">
                      ...
                      <span className="block mt-1 text-gray-800 dark:hs-tab-active:text-gray-200 dark:text-gray-200">
                        Quickly apply to your preferred roles, significantly
                ...
                >
                  <span className="flex">
                    ...
                    <span className="grow ms-6">
                      <span className="block text-lg font-semibold hs-tab-active:text-blue-600 text-gray-800 dark:hs-tab-active:text-blue-500 dark:text-gray-200">
                        AI-Enhanced Material Optimization
                      </span>
                      <span className="block mt-1 text-gray-800 dark:hs-tab-active:text-gray-200 dark:text-gray-200">
                        Rapidly improve your CV, cover letter, and resignation
                        letter using our AI-driven platform.
                      </span>
                    </span>
                  </span>
                </button>
                ...
                >
                  <span className="flex">
                    ...
                    <span className="grow ms-6">
                      ...
                      <span className="block mt-1 text-gray-800 dark:hs-tab-active:text-gray-200 dark:text-gray-200">
                        Get detailed feedback on your application's match to job
                        requirements, along with actionable advice to increase
                        your compatibility.
                      </span>
                    </span>
                  </span>
                ...
                >
                  <span className="flex">
                    ...
                    <span className="grow ms-6">
                      ...
                      <span className="block mt-1 text-gray-800 dark:hs-tab-active:text-gray-200 dark:text-gray-200">
                        Ensure your application passes through Applicant
                        Tracking Systems with our targeted optimization,
                        enhancing your visibility to employers.
                      </span>
                    </span>
                  </span>
                </button>
