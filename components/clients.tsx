...
const ClientsSection = () => {
  return (
    <>
      <section className="relative  bg-gray-50 dark:bg-slate-800" id="clients">
        {/* Clients */}
        <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-10 mx-auto">
          ...
          <div className="w-2/3 sm:w-1/2 lg:w-1/3 mx-auto text-center mb-6">
            <h2 className="text-gray-600 font-semibold text-xl dark:text-gray-400">
              Trusted by more than 50,000 professionals.
            </h2>
          </div>
          {/* End Title */}
          {/* Grid */}
