      ...
      <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        ...
        <div className="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
          ...
          <h2 className="text-2xl font-bold md:text-4xl md:leading-tight dark:text-white">
            ADVANCED JOB SEARCH AUTOMATION
          </h2>
        </div>
        {/* End Title */}
        {/* Grid */}
          ...
          <div className="lg:col-span-12">
            <div className="grid sm:grid-cols-2 gap-8 md:gap-12">
              <div className="relative w-full h-auto">
                <div className="bg-gray-800 rounded-2xl p-5  xl:p-8 h-full">
                  <div className="block">
                    <svg
                      width={30}
                      height={30}
                  ...
                  <h3 className="py-5 text-white text-lg font-bold xl:text-xl">
                    Customizable CV and Cover Letter Automation
                  </h3>
                  <p className="text-xs font-normal text-white mb-8">
                    Effortlessly tailor your applications for each job opening
                    with our sophisticated automation tools.
                  </p>
              ...
              <div className="relative w-full h-auto">
                <div className="bg-violet-500 rounded-2xl p-5 xl:p-8 h-full">
                  ...
                  <p className="text-xs font-normal text-white mb-8">
                    Over 50 automations at your fingertips to streamline every
                    aspect of your job application process.
                  </p>
                  <button className="py-2 px-5 border border-solid border-gray-300 rounded-full gap-2 text-xs text-white font-semibold flex items-center justify-between transition-all duration-500 hover:bg-white/5">
                    View More
                    <svg
              ...
              <div className="relative w-full h-auto">
                <div className="bg-indigo-500 rounded-2xl p-5  xl:p-8 h-full">
                  <div className="block">
                    <i className="bi bi-file-earmark-easel text-white  text-3xl"></i>
                  </div>
                  <h3 className="py-5 text-white text-lg font-bold xl:text-xl">
                    Versatile Workflow Templates
                  </h3>
                  <p className="text-xs font-normal text-white mb-8">
                    Utilize our wide array of templates to match your unique
              ...
              <div className="relative w-full h-auto">
                <div className="bg-teal-500 rounded-2xl p-5 xl:p-8 h-full">
                  <div className="block">
                    <i className="bi bi-pc-display text-white  text-3xl"></i>
                  </div>
                  <h3 className="py-5 text-white text-lg font-bold xl:text-xl">
                    Seamless Job Platform Integrations
                  </h3>
                  <p className="text-xs font-normal text-white mb-8">
                    Directly connect with leading job sites like LinkedIn and
                    Indeed to optimize your search.
                  </p>
                  <button className="py-2 px-5 border border-solid border-gray-300 rounded-full gap-2 text-xs text-white font-semibold flex items-center justify-between transition-all duration-500 hover:bg-white/5">
                    View More
                    <svg
