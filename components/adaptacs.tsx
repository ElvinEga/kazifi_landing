          ...
          <div className="grid justify-center md:grid-cols-2 md:justify-between md:items-center gap-2">
            <div className="text-center md:text-start">
              ...
              <p className="mt-1 text-white font-medium">
                Over 50,000 professionals have already turbocharged their job
                search with Kazifi.
              </p>
            </div>
            {/* End Col */}
            ...
            <div className="grid gap-8 sm:grid-cols-1 md:gap-12 xl:grid-cols-1 xl:gap-16">
              ...
              <div className="flex gap-4 md:gap-6">
                <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-lg bg-indigo-500 text-white shadow-lg md:h-14 md:w-14 md:rounded-xl">
                  <i className="bi bi-wifi text-3xl"></i>
                </div>
                <div>
                  ...
                  <p className="mb-2 text-gray-500">
                    Effortlessly collect contact information for networking
              ...
              <div className="flex gap-4 md:gap-6">
                ...
                <div>
                  <h3 className="mb-2 text-lg font-semibold md:text-xl">
                    Innovative Application Tracking
                  </h3>
                  <p className="mb-2 text-gray-500">
                    With Kazifi, not only can you apply with ease, but you can
                    also track the progress of your applications and adjust your
              ...
              <div className="flex gap-4 md:gap-6">
                <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-lg bg-indigo-500 text-white shadow-lg md:h-14 md:w-14 md:rounded-xl">
                  <i className="bi bi-browser-chrome text-2xl"></i>
                </div>
                <div>
                  <h3 className="mb-2 text-lg font-semibold md:text-xl">
                    Browser Extension
                  ...
                  <p className="mb-2 text-gray-500">
                    Extend Your Reach with the Kazifi Chrome Extension Leverage
                    the full power of Kazifi directly from your browser. The
                    Chrome extension simplifies job harvesting, application, and
                    instant suitability feedback, integrating seamlessly into
                    your online job search activities.
                  </p>
                  <div className="mt-8 lg:mt-14">
                    <a
                      className="py-3 px-4 inline-flex items-center gap-x-2 text-lg font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-gray-900 disabled:opacity-50 disabled:pointer-events-none dark:bg-white dark:text-gray-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                      href="#"
                    >
                      Try Our Extension
                      <i className="bi bi-arrow-up-right-circle text-3xl"></i>
                    </a>
                  </div>
                </div>
              </div>
...
export default AdaptacsSection;
